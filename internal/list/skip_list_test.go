...
func TestNewSkipList(t *testing.T) {
	testCases := []struct {
		...
		{
			name:       "new skip list",
			compare:    Gadget.ComparatorRealNumber[int],
			level:      1,
			wantLevel:  1,
...
func TestSkipList_DeleteElement(t *testing.T) {
	testCases := []struct {
	...
	}{
		{
			...
			compare:   Gadget.ComparatorRealNumber[int],
			skiplist:  NewSkipListFromSlice[int]([]int{1, 3}, Gadget.ComparatorRealNumber[int]),
			value:     2,
			wantSlice: []int{1, 3},
			wantSize:  2,
			wantRes:   true,
		...
		},
		{
			name:      "delete 1 from []",
			compare:   Gadget.ComparatorRealNumber[int],
			skiplist:  NewSkipListFromSlice[int]([]int{}, Gadget.ComparatorRealNumber[int]),
			value:     1,
			wantSlice: []int{},
			wantSize:  0,
			wantRes:   true,
		},
		{
			...
			compare:   Gadget.ComparatorRealNumber[int],
			skiplist:  NewSkipListFromSlice[int]([]int{1}, Gadget.ComparatorRealNumber[int]),
			value:     1,
			wantSlice: []int{},
			wantSize:  0,
			wantRes:   true,
		},
		{
			...
			compare:   Gadget.ComparatorRealNumber[int],
			skiplist:  NewSkipListFromSlice[int]([]int{2}, Gadget.ComparatorRealNumber[int]),
			value:     1,
			wantSlice: []int{2},
			wantSize:  1,
			wantRes:   true,
		},
		{
			...
			compare:   Gadget.ComparatorRealNumber[int],
			skiplist:  NewSkipListFromSlice[int]([]int{1, 2, 3, 4, 5, 6, 7}, Gadget.ComparatorRealNumber[int]),
			value:     3,
...
func TestSkipList_Insert(t *testing.T) {
	testCases := []struct {
		...
		},
		{
			...
			compare:   Gadget.ComparatorRealNumber[int],
			skiplist:  NewSkipListFromSlice[int]([]int{1, 2, 3}, Gadget.ComparatorRealNumber[int]),
			value:     2,
...
func TestSkipList_Search(t *testing.T) {
	testCases := []struct {
		...
		},
		{
			...
			compare:   Gadget.ComparatorRealNumber[int],
			skiplist:  NewSkipListFromSlice[int]([]int{1, 2, 3, 4, 5, 6}, Gadget.ComparatorRealNumber[int]),
			value:     3,
		...
		},
		{
			...
			compare:   Gadget.ComparatorRealNumber[int],
			skiplist:  NewSkipListFromSlice[int]([]int{1, 2, 2, 3, 3, 4, 5, 6}, Gadget.ComparatorRealNumber[int]),
			value:     2,
...
func TestSkipList_randomLevel(t *testing.T) {
	sl := NewSkipListFromSlice[int]([]int{1, 2, 3}, Gadget.ComparatorRealNumber[int])
...
func TestSkipList_AsSlice(t *testing.T) {
	testCases := []struct {
		...
		},
		{
			name:      "[3,2,1]]",
			compare:   Gadget.ComparatorRealNumber[int],
			skiplist:  NewSkipListFromSlice[int]([]int{3, 2, 1}, Gadget.ComparatorRealNumber[int]),
			wantSlice: []int{1, 2, 3},
		},
		{
			name:      "[]",
