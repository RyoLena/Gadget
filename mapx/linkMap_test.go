...
func newLinkedFakeMap[K any, V any](activeFirstErr bool, comparator Gadget.Comparator[K]) (*LinkedMap[K, V], error) {
...
func TestLinkedMap_NewLinkedTreeMap(t *testing.T) {
	testCases := []struct {
		name       string
		comparator Gadget.Comparator[int]

		wantErr error
	}{
		{
			name:       "no error",
			comparator: Gadget.ComparatorRealNumber[int],
...
func TestLinkedMap_Put(t *testing.T) {
	testCases := []struct {
	...
	}{
		{
			name: "put single key",
			linkedMap: func(t *testing.T) *LinkedMap[int, int] {
				linkedTreeMap, err := NewLinkedTreeMap[int, int](Gadget.ComparatorRealNumber[int])
		...
		},
		{
			...
			linkedMap: func(t *testing.T) *LinkedMap[int, int] {
				linkedFakeMap, err := newLinkedFakeMap[int, int](true, Gadget.ComparatorRealNumber[int])
				assert.NoError(t, err)
...
func TestLinkedMap_Len(t *testing.T) {
	testCases := []struct {
	...
	}{
		{
			...
			linkedMap: func(t *testing.T) *LinkedMap[int, int] {
				linkedTreeMap, _ := NewLinkedTreeMap[int, int](Gadget.ComparatorRealNumber[int])
				return linkedTreeMap
			},
