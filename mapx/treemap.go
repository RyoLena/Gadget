...
var (
	errTreeMapComparatorIsNull = errors.New("gadget: Comparator不能为nil")
)
...
func NewTreeMapWithMap[K comparable, V any](compare Gadget.Comparator[K], m map[K]V) (*TreeMap[K, V], error) {
...
// 需注意比较器compare不能为nil
func NewTreeMap[K any, V any](compare Gadget.Comparator[K]) (*TreeMap[K, V], error) {
	if compare == nil {
